    ...
    <header id="hero" className=" h-svh text-white">
      <section className="flex flex-col justify-center items-center gap-6 sm:gap-6 md:gap-12">
        <h1 className="flex flex-col text-center text-3xl gap-4 mt-8">
          Hey, my name is
          <span className="pb-4 text-6xl md:text-7xl font-semibold text-transparent bg-clip-text inline-block bg-gradient-to-r from-fuchsia-500 to-cyan-500">
            Maharaj Haider
          </span>
        </h1>
        <div className="flex justify-center items-center">
          <img
            id="pfp"
            className="w-2/3 md:w-96 lg:w-[23%] rounded-full"
        ...
        <section className="flex flex-col md:flex-row gap-4 font-black">
          ...
          <a
            href="https://github.com/maharajhaider"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/maharajhaider/"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="mailto:maharajhaider@hotmail.com"
            rel="noopener noreferrer"
            target="_blank"
          >
