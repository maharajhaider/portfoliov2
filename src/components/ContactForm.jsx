...
const ContactForm = () => {
  ...
  return (
    <div className="flex justify-center h-auto md:h-auto overflow-hidden rounded-lg">
      <form
        className="p-8 md:p-12 border-2 rounded-xl flex flex-col w-full md:w-[80%] lg:w-[80%] gap-6"
        ref={form}
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            } rounded-md p-3 bg-white text-black placeholder-gray-500`}
          />
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            placeholder="Email"
            className={`border-2 ${
              errors.client_email ? "border-rose-500" : ""
            } rounded-md p-3 bg-white text-black placeholder-gray-500`}
          />
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className={`border-2 ${
              errors.client_phone ? "border-rose-500" : ""
            } rounded-md p-3 bg-white text-black placeholder-gray-500`}
          />
          <p className="text-red-500 font-semibold">
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            className={`border-2 ${
              errors.client_message ? "border-rose-500" : ""
            } rounded-md px-2 pb-10 md:px-4 md:pt-4 md:pb-20 resize-none bg-white text-black placeholder-gray-500`}
